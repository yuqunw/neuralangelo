...
def parse_args():
    ...
    parser.add_argument('--checkpoint', default=None, help='Checkpoint path.', required=True)
...
def main():
    ...
    trainer.checkpointer.load(args.checkpoint, resume=True, load_sch=True, load_opt=True)
    ...
    # Start training.
    trainer.test(trainer.eval_data_loader,
                 mode = 'val',
